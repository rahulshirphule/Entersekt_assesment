...
class MallsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = malls[indexPath.row].name;
        ...
        entersketSDK.getListofShopsInMall(cityId: cityId,mallId: malls[indexPath.row].id!, { (data)
            ...
            if data != nil {
                ...
                DispatchQueue.main.async {
                    ...
                    shopsViewController.cityId = self.cityId;
                    shopsViewController.mallName = self.malls[indexPath.row].name!;
